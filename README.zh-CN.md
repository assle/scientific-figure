...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/版本-0.3.2-blue" alt="版本 0.3.2">
...
当前 `0.3.2` 版本提供 **原生 Codex 插件**、独立 OpenCode Agent 集成和带版本的
...
项目当前处于 1.0 之前，`0.y.z` 版本仍可能调整公开接口。`v0.3.2` 是最新固定发布。
