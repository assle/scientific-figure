...
The current `0.3.3` release ships a **Native Codex plugin**, an OpenCode
...
interfaces. `v0.3.3` is the latest fixed release. A release exists only when the repository has an immutable
