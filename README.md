...
The current `0.4.0` release ships a **Native Codex plugin**, an OpenCode
...
interfaces. `v0.4.0` is the latest fixed release. A release exists only when the repository has an immutable
